package com.connection.driverModule.notificationPkg.adapterPkg;
...
public class DriverNotificationAdapter extends RecyclerView.Adapter<DriverNotificationAdapter.ViewHolder> {
    ...
    public DriverNotificationAdapter(Context context, NotificationOnClickListener notificationOnClickListener) {
